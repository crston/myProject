...
<script src="${path}/resources/js/tippvereply.js"></script>
...
//				displayList();				
		...
		$("#btn-modify").click(() => {
			location.href="<c:url value='/tippvemodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
