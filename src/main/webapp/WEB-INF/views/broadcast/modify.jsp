...
<div class="container d-flex mt-5 justify-content-center">
	...
	<form id="modifyForm" method="post" action="bdmodify.do" onSubmit="return false;">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#btn-remove").click(() => {
			location.href="<c:url value='/bdremove.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
