...
<script src="${path}/resources/js/updatereply.js"></script>
...
//				displayList();				
		...
		$("#btn-list").click(() => {
			location.href="<c:url value='/upupdate.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
		
		$("#btn-modify").click(() => {
			location.href="<c:url value='/upmodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
