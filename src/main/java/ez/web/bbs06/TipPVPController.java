...
import ez.web.service.TipPVPService;

@Controller
public class TipPVPController {
	
	@Autowired
	private TipPVPService service;
	
	@RequestMapping(value="/tippvpregister.do", method=RequestMethod.GET)
	public String registerForm(HttpSession session, Model model) {
		...
		return "tippvp/register";
	}
	
	@RequestMapping(value="/tippvpregister.do", method=RequestMethod.POST)
	public String register(BoardDTO board) {
		
		service.register(board);
		
		return "redirect:/tippvptippvp.do";
	}
	
	@RequestMapping("/tippvpview.do")
	public String view(int bid, @ModelAttribute("pDto") PageDTO pDto, Model model) {
		BoardDTO board = service.view(bid, "view");
		model.addAttribute("board", board);
		return "tippvp/view"; //view.jsp
	}
	
	@RequestMapping(value="/tippvpmodify.do", method=RequestMethod.GET)
	public String modifyForm(int bid, @ModelAttribute("pDto") PageDTO pDto, HttpSession session, Model model) {
		...
		return "tippvp/modify"; // modify.jsp
	}
	
	@RequestMapping(value="/tippvpmodify.do", method=RequestMethod.POST)
	...
	@RequestMapping("/tippvpremove.do")
	...
	@RequestMapping("/tippvptippvp.do")
