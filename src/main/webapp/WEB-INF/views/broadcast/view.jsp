...
<script src="${path}/resources/js/broadcastreply.js"></script>
...
//				displayList();				
		...
		$("#btn-list").click(() => {
			location.href="<c:url value='/bdbroadcast.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
		
		$("#btn-modify").click(() => {
			location.href="<c:url value='/bdmodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
