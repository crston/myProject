...
import ez.web.service.RecruitService;
...
public class RecruitController {
	...
	@RequestMapping(value="/recruitregister.do", method=RequestMethod.GET)
	...
	@RequestMapping(value="/recruitregister.do", method=RequestMethod.POST)
	public String register(BoardDTO board) {
		
		service.register(board);
		
		return "redirect:/recruitrecruit.do";
	}
	...
	public String view(int bid, @ModelAttribute("pDto") PageDTO pDto, Model model) {
		...
		return "recruit/view"; //view.jsp
	}
	
	@RequestMapping(value="/recruitmodify.do", method=RequestMethod.GET)
	public String modifyForm(int bid, @ModelAttribute("pDto") PageDTO pDto, HttpSession session, Model model) {
		...
		return "recruit/modify"; // modify.jsp
	}
	...
	@RequestMapping("/recruitremove.do")
	...
	@RequestMapping("/recruitrecruit.do")
