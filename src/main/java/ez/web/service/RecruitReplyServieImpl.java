...
import ez.web.mapper.RecruitReplyMapper;

@Service("RecruitReplyMapper")
public class RecruitReplyServieImpl implements RecruitReplyService{

	@Autowired
	private RecruitReplyMapper mapper;
