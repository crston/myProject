...
<script src="${path}/resources/js/freereply.js"></script>
...
//				displayList();				
		...
		$("#btn-list").click(() => {
			location.href="<c:url value='/freefree.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
		
		$("#btn-modify").click(() => {
			location.href="<c:url value='/freemodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
