...
import ez.web.mapper.BroadcastReplyMapper;

@Service("BroadcastReplyMapper")
public class BroadcastReplyServieImpl implements BroadcastReplyService{

	@Autowired
	private BroadcastReplyMapper mapper;
