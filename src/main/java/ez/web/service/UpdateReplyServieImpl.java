...
import ez.web.mapper.UpdateReplyMapper;

@Service("UpdateReplyMapper")
public class UpdateReplyServieImpl implements UpdateReplyService{

	@Autowired
	private UpdateReplyMapper mapper;
