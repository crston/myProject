...
<script src="${path}/resources/js/eventreply.js"></script>
...
//				displayList();				
		...
		$("#btn-list").click(() => {
			location.href="<c:url value='/evevent.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
		
		$("#btn-modify").click(() => {
			location.href="<c:url value='/evmodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
