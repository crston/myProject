...
import ez.web.service.TipPVEService;

@Controller
public class TipPVEController {
	
	@Autowired
	private TipPVEService service;
	
	@RequestMapping(value="/tippveregister.do", method=RequestMethod.GET)
	public String registerForm(HttpSession session, Model model) {
		...
		return "tippve/register";
	}
	
	@RequestMapping(value="/tippveregister.do", method=RequestMethod.POST)
	public String register(BoardDTO board) {
		
		service.register(board);
		
		return "redirect:/tippvetippve.do";
	}
	
	@RequestMapping("/tippveview.do")
	public String view(int bid, @ModelAttribute("pDto") PageDTO pDto, Model model) {
		BoardDTO board = service.view(bid, "view");
		model.addAttribute("board", board);
		return "tippve/view"; //view.jsp
	}
	
	@RequestMapping(value="/tippvemodify.do", method=RequestMethod.GET)
	public String modifyForm(int bid, @ModelAttribute("pDto") PageDTO pDto, HttpSession session, Model model) {
		...
		return "tippve/modify"; // modify.jsp
	}
	
	@RequestMapping(value="/tippvemodify.do", method=RequestMethod.POST)
	...
	@RequestMapping("/tippveremove.do")
	...
	@RequestMapping("/tippvetippve.do")
