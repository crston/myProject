...
import ez.web.mapper.TipPVEReplyMapper;

@Service("TipPVEReplyMapper")
public class TipPVEReplyServieImpl implements TipPVEReplyService{

	@Autowired
	private TipPVEReplyMapper mapper;
