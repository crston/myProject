...
<script src="${path}/resources/js/tippvpreply.js"></script>
...
//				displayList();				
		...
		$("#btn-list").click(() => {
			location.href="<c:url value='/tippvptippvp.do?viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
		
		$("#btn-modify").click(() => {
			location.href="<c:url value='/tippvpmodify.do?bid=${board.bid}&viewPage=${pDto.viewPage}&searchType=${pDto.searchType}&keyWord=${pDto.keyWord}'/>";
		})
	});
</script>
