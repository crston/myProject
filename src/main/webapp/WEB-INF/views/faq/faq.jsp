...
<section class="cd-faq js-cd-faq container max-width-md margin-top-lg margin-bottom-lg">
	<ul class="cd-faq__categories">
		<li><a class="cd-faq__category cd-faq__category-selected truncate" href="#1">자주 묻는 질문</a></li>
		<li><a class="cd-faq__category truncate" href="#2">보안</a></li>
		<li><a class="cd-faq__category truncate" href="#3">조작</a></li>
		<li><a class="cd-faq__category truncate" href="#4">결제</a></li>
		<li><a class="cd-faq__category truncate" href="#5">전쟁</a></li>
		<li><a class="cd-faq__category truncate" href="#6">음식 시키신 분</a></li>
	</ul> <!-- cd-faq__categories -->

	<div class="cd-faq__items">
		<ul id="1" class="cd-faq__group">
			<li class="cd-faq__title"><h2>자주 묻는 질문</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>비밀번호를 잃어버렸습니다</span></a>
          ...
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>가입하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>글을 지우고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>플레이하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="2" class="cd-faq__group">
			<li class="cd-faq__title"><h2>보안</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>해킹을 당한 것 같습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>복구를 신청합니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>계정 탈퇴를 하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="3" class="cd-faq__group">
			<li class="cd-faq__title"><h2>조작</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>조작법을 모르겠습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>튜토리얼을 진행할 수 없습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>이동할 수 없습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>접속할 수 없습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
		...
		<ul id="4" class="cd-faq__group">
			<li class="cd-faq__title"><h2>결제</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>환불하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>결제가 잘못된 것 같습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>캐시가 정상적으로 지급되지 않았습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="5" class="cd-faq__group">
			<li class="cd-faq__title"><h2>전쟁</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>내래 혁명하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>간첩을 신청하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>서버를 폭파시키려고 합니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>핵을 사용하고 싶습니다</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
		...
		<ul id="6" class="cd-faq__group">
			<li class="cd-faq__title"><h2>음식 시키신 분</h2></li>
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>짜장면</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>짬뽕</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>탕수육</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>피자</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Impedit quidem delectus rerum eligendi mollitia, repudiandae quae beatae. Et repellat quam atque corrupti iusto architecto impedit explicabo repudiandae qui similique aut iure ipsum quis inventore nulla error aliquid alias quia dolorem dolore, odio excepturi veniam odit veritatis. Quo iure magnam, et cum. Laudantium, eaque non? Tempore nihil corporis cumque dolor ipsum accusamus sapiente aliquid quis ea assumenda deserunt praesentium voluptatibus, accusantium a mollitia necessitatibus nostrum voluptatem numquam modi ab, sint rem.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>카레</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>곱창</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>파스타</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>햄버거</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
			...
			<li class="cd-faq__item">
				<a class="cd-faq__trigger" href="#0"><span>치킨</span></a>
				<div class="cd-faq__content">
          <div class="text-component">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Blanditiis provident officiis, reprehenderit numquam. Praesentium veritatis eos tenetur magni debitis inventore fugit, magnam, reiciendis, saepe obcaecati ex vero quaerat distinctio velit.</p>
          </div>
	...
	<a href="#0" class="cd-faq__close-panel text-replace">닫기</a>
  
  <div class="cd-faq__overlay" aria-hidden="true"></div>
</section> <!-- cd-faq -->
<script src="${path}/resources/js/faqutil.js"></script> <!-- util functions included in the CodyHouse framework -->
<script src="${path}/resources/js/faqmain.js"></script>
</body>
</html>